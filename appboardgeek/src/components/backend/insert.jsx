...
export const Insert = () => {
    ...
    const handleSubmit = e => {
        ...
        setPrice('')
        setThumbnail('')
        console.log(id, title, description, publisher, language, dificulty, min_players, max_players, price, play_time, thumbnail)
    }
            ...
            <div style={{width:"50%", backgroundColor:"lightgrey", margin:"0 auto", padding:"10px",}}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group col-md-3">
                            ...
                            <input type='number' value={min_players} onChange={ evt => setMinPlayers(evt.target.value)}/>
                    </div>
                    <div className="form-group col-md-3">
                            <label><b>Jugadores máximos</b></label>
                            <input type='number' value={max_players} onChange={ evt => setMaxPlayers(evt.target.value)}/>
                    </div>
                    <div className="form-group col-md-3">
